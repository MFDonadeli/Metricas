		...
		?>
				...
				<header id="header">
					<div id="logo-group">
						...
						<span id="logo"> <img src="<?php echo ASSETS_URL; ?>/img/super.png" alt="SuperAdMetrics"> </span>
						...
						<ul class="header-dropdown-list hidden-xs">
							<li>
								<a href="#" class="dropdown-toggle" data-toggle="dropdown"> 
									<img src="<?php echo ASSETS_URL; ?>/img/blank.gif" class="flag flag-br" alt="Brasil"> <span> BR</span> <i class="fa fa-angle-down"></i> </a>
								<ul class="dropdown-menu pull-right">
									<li class="active">
										<a href="javascript:void(0);"><img src="<?php echo ASSETS_URL; ?>/img/blank.gif" class="flag flag-br" alt="Brasil"> Português (BR)</a>
									</li>
									<li>
